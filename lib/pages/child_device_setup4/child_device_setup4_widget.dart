                                                        ...
                                                        try {
                                                          ...
                                                          if (pairingCode !=
                                                            ...
                                                            if (device !=
                                                              ...
                                                              print(
                                                                  '⚠️ Device not found for pairing code: $pairingCode');
                                                              if (mounted) {
                                                                ScaffoldMessenger.of(
                                                                        context)
                                                                    .showSnackBar(
                                                                  const SnackBar(
                                                                    content: Text(
                                                                        '⚠️ Device not found. Complete pairing first.'),
                                                                    duration: Duration(
                                                                        seconds:
                                                                            3),
                                                                  ),
                                                            ...
                                                            print(
                                                                '⚠️ No pairing code found in setup data');
                                                            if (mounted) {
                                                              ScaffoldMessenger
                                                                      .of(context)
                                                                  .showSnackBar(
                                                                const SnackBar(
                                                                  content: Text(
                                                                      '⚠️ No pairing code found. Complete setup first.'),
                                                                  duration:
                                                                      Duration(
                                                                          seconds:
                                                                              3),
